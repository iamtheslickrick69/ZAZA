...
const items: AccordionItem[] = [
  {
    ...
    title: "Strategy",
    content:
      "Deep dive into your business, audience, and goals to build a plan that actually works.",
  },
  {
    id: "design",
    number: "02",
    title: "Design",
    content: "Craft the systems, sites, and brand identity that set you apart.",
  },
  {
    id: "deploy",
    number: "03",
    title: "Deploy",
    content: "Build fast, launch confidently, and iterate based on real data.",
  },
  {
    id: "win",
    number: "04",
    title: "Win Together",
    content: "Your success is our success. We're partners, not vendors.",
  },
]

export function UniqueAccordion() {
  const [activeId, setActiveId] = useState<string | null>("strategy")
