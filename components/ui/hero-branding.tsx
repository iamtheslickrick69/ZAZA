...
import { Rocket, Eye, Layers, Zap, Target, Calendar } from "lucide-react";
  ...
  return (
    <section className="relative pt-32 pb-16">
      <div className="max-w-6xl mx-auto px-6">
        ...
        {/* LAYER 2: Title + Subtitle (Centered) */}
        <motion.div
        ...
        >
          ...
          <div className="flex flex-col items-center">
            ...
            <motion.div
              className="h-px w-full max-w-md mt-4 overflow-hidden"
              initial={{ scaleX: 0 }}
              animate={{ scaleX: 1 }}
            ...
            <div className="group relative overflow-hidden p-8 md:border-r border-border">
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm text-muted-foreground font-body leading-relaxed pl-4">
                  Your site shouldn&apos;t be a PDF — it should think, respond, and sell
                </p>
              </div>
            </div>
