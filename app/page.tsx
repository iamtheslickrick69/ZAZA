...
import { AnimatedServiceIcons } from "@/components/ui/animated-service-icons";
  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="bg-background pt-20 pb-8">
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center">
              {/* Insights Title */}
              <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-8">Insights</h2>

              {/* Social Icons + Subscribe Row */}
              <div className="flex flex-col sm:flex-row items-center gap-6 mb-12 w-full max-w-xl">
                {/* Social Icons */}
                ...
                {/* Subscribe Form */}
                <form className="flex flex-1 w-full sm:w-auto space-x-2">
                  <input
                    type="email"
                    placeholder="Enter your email"
                    className="flex-grow h-11 px-4 rounded-full border border-border bg-transparent text-foreground placeholder:text-muted-foreground focus:outline-none focus:border-foreground transition-colors"
                  />
                  <button type="submit" className="h-11 px-6 rounded-full bg-foreground text-background font-medium hover:bg-foreground/90 transition-colors whitespace-nowrap">
                    Subscribe
                  </button>
                </form>
              </div>
        ...
        <section className="flex flex-col items-center justify-center bg-background pb-20">
          <AnimatedCardStack />
        </section>
